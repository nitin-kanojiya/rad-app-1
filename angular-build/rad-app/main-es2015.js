...
let OurServicesService = class OurServicesService {
    ...
    getHandyman() {
        return this.http
            .get("http://localhost:3000/api/handymans");
        // .pipe(
        //   map(handymanData => {
    ...
    createHandyman(newHandymanDetails) {
        ...
        for (const key in newHandymanDetails) {
            ...
            if (key == "id") {
                // console.info("id not added");          
            }
        }
        this.http
            .post("http://localhost:3000/api/handymans", handymanData)
