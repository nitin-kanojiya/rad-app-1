...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function () {
      ...
      _createClass(HandymanListComponent, [{
        ...
        value: function gotoDetailsPage(IdHandymanForDetails) {
          ...
          var entered = false; // let inserted:boolean = false;

          var customerName = prompt("Please enter your Name:");
          var customerContact = prompt("Please enter your contact number:");
  ...
  function srcAppOurServicesServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/environments/environment.prod.ts"); // import { environment } from 'src/environments/environment';


    var BACKEND_URL = src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl;
